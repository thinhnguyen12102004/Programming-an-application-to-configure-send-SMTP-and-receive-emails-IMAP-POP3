...
namespace Server
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.ClientSize = new System.Drawing.Size(96, 57);
...
// Chương trình chính 
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
            ...
            //Tham số false của phương thức mới đại diện cho ensureSecurity, nghĩa là không bật bảo mật cho kênh
		...
		private void menuItem1_Click(object sender, System.EventArgs e)
		{
            ...
            if (pass == "123") // Mật khẩu thoát chương trình 
            {
                Application.Exit();
            }
            else
